    ...
    return (
      <div className="flex-1 flex items-center justify-center py-8">
        <div className="text-center">
          ...
          <h3 className="text-sm font-medium text-gray-900 mb-1">No hay comentarios</h3>
          <p className="text-sm text-gray-500">Sé el primero en dejar un comentario sobre este pedido.</p>
        </div>
      </div>
    );
  }
