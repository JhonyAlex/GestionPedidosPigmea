...
import { formatDecimalHoursToHHMM } from '../utils/date';
            ...
            <div className="overflow-x-auto border border-gray-200 rounded-lg bg-gray-50 p-4">
                ...
                >
                    ...
                    {[0, 0.2, 0.4, 0.6, 0.8, 1].map(ratio => {
                        ...
                        const valueLabel = formatDecimalHoursToHHMM(value);
                                            ...
                                            <div key={key} className="relative flex flex-col justify-end h-full group" style={{ width: `${100 / sortedKeys.length}%` }}>
                                                ...
                                                {value > 0 && (
                                                    <div
                                                        ...
                                                        style={{
                                                            bottom: `${(heightPercent / 100) * chartHeight + 6}px`,
                                                            whiteSpace: 'nowrap'
                                                        }}
                                                    >
                                                        <div className="relative">
                                                            <span className="text-[10px] font-bold text-gray-700 bg-white px-1.5 py-0.5 rounded shadow-md inline-block border border-gray-200 group-hover:bg-blue-50 group-hover:scale-110 transition-all">
                                                                {formatDecimalHoursToHHMM(value)}
                                                            </span>
                                                ...
                                                {/* The Bar */}
                                                <div
                                                    className={`w-full rounded-t-md transition-all duration-300 hover:brightness-110 border-2 border-opacity-50 relative ${onBarClick ? 'cursor-pointer hover:scale-105 hover:shadow-lg' : ''
                                                        }`}
                                                    style={{
                                                    ...
                                                    title={`${MACHINE_LABELS[key]}: ${formatDecimalHoursToHHMM(value)}`}
