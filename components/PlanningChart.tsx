...
export const PlanningChart: React.FC<PlanningChartProps> = ({ data, machineKeys, onBarClick }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-lg mt-8">
            ...
            <div className="overflow-x-auto overflow-y-hidden border border-gray-200 rounded-lg bg-gray-50 p-4">
                <div className="relative" style={{ width: `${chartWidth}px`, height: `${chartHeight}px` }}>
                    ...
                    {/* Bars Area */}
                    <div className="absolute inset-0 flex items-end ml-20 pl-4 pb-16 gap-2">
