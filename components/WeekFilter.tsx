        ...
        <div className="relative" ref={panelRef}>
            {isCompact ? (
                <button
                    ...
                    className="px-2.5 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
