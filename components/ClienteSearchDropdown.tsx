...
interface ClienteSearchDropdownProps {
    searchTerm: string;
...
const ClienteSearchDropdown: React.FC<ClienteSearchDropdownProps> = ({
    searchTerm,
    onSearchChange,
    results,
    onSelectCliente,
    ...
    return (
        <>
            {/* Overlay de fondo */}
            <div 
                className="fixed inset-0 bg-black/20 dark:bg-black/40 z-40 cliente-search-dropdown" 
                onClick={(e) => {
                    e.stopPropagation();
                    onClose();
                }}
            ...
            {/* Dropdown */}
            <div 
                className="cliente-search-dropdown fixed inset-x-4 top-20 z-50 max-w-4xl mx-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-2xl max-h-[calc(100vh-8rem)] flex flex-col"
                onClick={(e) => {
                    e.stopPropagation();
                }}
            >
...
export default ClienteSearchDropdown;
