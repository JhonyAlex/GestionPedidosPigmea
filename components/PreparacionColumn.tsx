                ...
                <Droppable droppableId={`PREP_${columna.id}`}>
                    {(provided, snapshot) => (
                        <div
                            ...
                            className={`flex-grow p-4 transition-colors duration-150 ease-in-out ${snapshot.isDraggingOver ? 'bg-gray-300 dark:bg-gray-700' : 'bg-gray-200 dark:bg-gray-800'} rounded-b-xl overflow-y-auto min-h-[300px]`}
                        >
