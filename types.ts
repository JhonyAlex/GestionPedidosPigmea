...
export enum Etapa {
    ...
    POST_LAMINACION_SL2_EVO = 'POST_LAMINACION_SL2_EVO',
    ...
    POST_PERFORACION_MAC2 = 'POST_PERFORACION_MAC2',
...
export interface Pedido {
    ...
    semanaManual?: boolean; // true = user manually selected semana (no auto-derive); false/undefined = auto from nuevaFechaEntrega
